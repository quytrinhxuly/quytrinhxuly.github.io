...
export const de_xuat_gia_ban_voi_loai_dich_vu = getData(quy_trinh_xy_ly_metadata, "de_xuat_gia_ban_voi_loai_dich_vu");
export const tinh_trang_khach_hang = getData(quy_trinh_xy_ly_metadata, "tinh_trang_khach_hang");
export const mo_ta_ly_do_de_xuat = getData(quy_trinh_xy_ly_metadata, "mo_ta_ly_do_de_xuat");
...
export const ty_trong_don_noi_vung_lien_vung = getData(quy_trinh_xy_ly_metadata, "ty_trong_don_noi_vung_lien_vung");

export const so_nam_ban_hang = getData(quy_trinh_xy_ly_metadata, "so_nam_ban_hang");
export const so_nhan_vien_cua_shop = getData(quy_trinh_xy_ly_metadata, "so_nhan_vien_cua_shop");
export const kenh_ban_hang_online = getData(quy_trinh_xy_ly_metadata, "kenh_ban_hang_online");
export const luot_theo_doi_hoac_thich_kenh = getData(quy_trinh_xy_ly_metadata, "luot_theo_doi_hoac_thich_kenh");
export const co_chay_quang_cao_khong = getData(quy_trinh_xy_ly_metadata, "co_chay_quang_cao_khong");
export const co_livestream_ban_hang_khong = getData(quy_trinh_xy_ly_metadata, "co_livestream_ban_hang_khong");
export const loai_gia_dang_di_theo_tuyen = getData(quy_trinh_xy_ly_metadata, "loai_gia_dang_di_theo_tuyen");
export const loai_gia_dang_di_theo_khoi_luong = getData(quy_trinh_xy_ly_metadata, "loai_gia_dang_di_theo_khoi_luong");
export const chinh_sach_phu_phi = getData(quy_trinh_xy_ly_metadata, "chinh_sach_phu_phi");
