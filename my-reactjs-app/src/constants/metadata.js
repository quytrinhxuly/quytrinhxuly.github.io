...
/// new
export const hinh_thuc_dang_ky = getData(
  quy_trinh_xy_ly_metadata,
  "hinh_thuc_dang_ky"
);

export const san_luong_dang_di = getData(
  quy_trinh_xy_ly_metadata,
  "san_luong_dang_di"
);
export const gia_ban_dang_di = getData(
  quy_trinh_xy_ly_metadata,
  "gia_ban_dang_di_10kg"
);
export const doanh_thu_hang_nang_dang_di_ben_doi_thu = getData(
  quy_trinh_xy_ly_metadata,
